exports.run = async (bot, msg, args) => {
	...
	let user = null;
	await bot.database.getUser(msg.author).then((u) => {user = u});
	...
	bot.database.models.User.model.update({points: (user.points - price), background: url}, {where: {uid: user.uid}}).then((row) => {
